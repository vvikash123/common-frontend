  ...
  return (
    <div className={s['WhereToStudy']}>
      <ContainerBox>
        ...
        <div className={s['SearchWidget']} style={{ margin: '20px 0 40px' }}>
        <SearchWidget margin="0" whiteBg={false} button={true}  placeholder={"Location"} type={'location'}/>

        </div>

        <CommonGridBox gridType={'gridBox'} changeStyle={'grid-2'} yGap={10} xGap={10}>
